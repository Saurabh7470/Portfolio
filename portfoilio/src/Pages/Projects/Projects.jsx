...
function Projects(){
    const data = [
        {name: "Project Management", Desc : "Project management system is all about to maintain detials and distibute the work over an organination.", Type:"Web Project", imgUrl:"https://projectsly.com/images/blog/project-management-system-overview.png?v=1670514978795773617"},
